...
RSpec.describe "Test Simple Output Value is Correct over Multiple Entries" do
  ...
  it 'Call find_discrepancy with no discrepancy' do
    f1 = "csv_files/test8_f1.csv"
    f2 = "csv_files/test8_f2.csv"
    f3 = "csv_files/test8_f3.csv"

    expect(find_discrepancy([f1,f2,f3])).to be == ["test_1@gmail.com", "test_3@gmail.com", "test_5@gmail.com", "test_8@gmail.com", "test_10@gmail.com"]
  end
