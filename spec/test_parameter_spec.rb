...
RSpec.describe "Test Parameter Count" do
  ...
  it 'Call find_discrepancy with 0 paramters' do
    expect{find_discrepancy}.to raise_error(ArgumentError)
  end

  it 'Call find_discrepancy with 0 files' do
    expect{find_discrepancy(["test1_f1.csv"])}.to raise_error("Need at least two files")
  end

  it 'Call find_discrepancy with 1 file' do
    expect{find_discrepancy(["test1_f1.csv"])}.to raise_error("Need at least two files")
  end
